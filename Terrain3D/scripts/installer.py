#!/usr/bin/env python3
"""Instalador Terrain3D — usa o instalador unificado do monorepo.

Uso:
  ./install.sh terrain3d
  python3 scripts/installer.py
  gamedev-install terrain3d
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Instalador Terrain3D",
        epilog="Forma oficial: ./install.sh terrain3d",
    )
