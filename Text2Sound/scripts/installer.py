#!/usr/bin/env python3
"""
Instalador Text2Sound — usa o instalador unificado do monorepo.

Uso:
  ./install.sh text2sound
  python3 scripts/installer.py
  gamedev-install text2sound
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Instalador Text2Sound",
        epilog="""
Forma oficial: ./install.sh text2sound
