#!/usr/bin/env python3
"""
Instalador Texture2D — usa o instalador unificado do monorepo.

Uso:
  ./install.sh texture2d
  python3 scripts/installer.py
  gamedev-install texture2d
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Instalador Texture2D",
        epilog="""
Forma oficial: ./install.sh texture2d
