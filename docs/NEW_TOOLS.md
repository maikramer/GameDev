...
- [INSTALLING.md](INSTALLING.md) — forma oficial de instalar e tabela de ferramentas.
- [Shared/README.md](../Shared/README.md) — `gamedev-install`, módulos partilhados.
- [GameAssets/README.md](../GameAssets/README.md) — variáveis `*_BIN` e fluxos de batch.
